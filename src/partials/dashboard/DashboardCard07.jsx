  ...
  return (
    <div className="col-span-full xl:col-span-8 bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        <h2 className="font-semibold text-slate-800">Top Fonte de Clientes</h2>
      </header>
      <div className="p-3">
          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                ...
                <th className="p-2">
                  <div className="font-semibold text-center">Planos Gerados</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Receita</div>
                </th>
                <th className="p-2">
