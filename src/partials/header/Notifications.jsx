          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Edite a sua informação num clique</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
            ...
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀<span className="font-medium text-slate-800">Diga adeus a planos de negócios em papel!</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
                <span className="block text-xs font-medium text-slate-400">16 Jan, 2023</span>
              </Link>
            </li>
          </ul>
        </div>
